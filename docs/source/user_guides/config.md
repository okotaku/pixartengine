...
Usually, we use python files as config file. All configuration files are placed under the [`configs`](https://github.com/okotaku/pixartengine/tree/main/diffengine/configs) folder, and the directory structure is as follows:
...
- [models](https://github.com/okotaku/pixartengine/tree/main/diffengine/configs/_base_/models)
- [datasets](https://github.com/okotaku/pixartengine/tree/main/diffengine/configs/_base_/datasets)
- [schedules](https://github.com/okotaku/pixartengine/tree/main/diffengine/configs/_base_/schedules)
- [runtime](https://github.com/okotaku/pixartengine/blob/main/diffengine/configs/_base_/default_runtime.py)
...
For easy understanding, we use [stable_diffusion_v15_pokemon_blip config file](https://github.com/okotaku/pixartengine/blob/main/diffengine/configs/stable_diffusion/stable_diffusion_v15_pokemon_blip.py) as an example and comment on each line.
...
Following is the model primitive config of the stable_diffusion_v15 config file in [`configs/_base_/models/stable_diffusion_v15.py`](https://github.com/okotaku/pixartengine/blob/main/diffengine/configs/_base_/models/stable_diffusion_v15.py):
...
Following is the data primitive config of the stable_diffusion_v15 config in [`configs/_base_/datasets/pokemon_blip.py`]https://github.com/okotaku/pixartengine/blob/main/diffengine/configs/_base_/datasets/pokemon_blip.py)：
...
Following is the schedule primitive config of the stable_diffusion_v15 config in [`configs/_base_/schedules/stable_diffusion_50e.py`](https://github.com/okotaku/pixartengine/blob/main/diffengine/configs/_base_/schedules/stable_diffusion_50e.py)：
...
Here is the runtime primitive config file ['configs/_base_/default_runtime.py'](https://github.com/okotaku/pixartengine/blob/main/diffengine/configs/_base_/default_runtime.py) file used by almost all configs:
